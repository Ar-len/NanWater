<template>
  <div class="login">
    <el-row>
      <el-col :span="8" :offset="16" class="login-container-left">
        <div class="login-container">
          <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="right">
            ...
            <div style="width:100%;text-align: center;">
              ...
              >登录<i class="el-icon-right" /></el-button>
            </div>
            <el-row style="padding:10px 50px">
              <el-button icon="el-icon-edit" circle size="160" />
...
.login{
  min-height: 100%;
  width: 100%;
  background-image: url('../../assets/images/登录背景.webp');
  // background-color: $bg;
  overflow: hidden;
  .login-container {
  .login-form {
